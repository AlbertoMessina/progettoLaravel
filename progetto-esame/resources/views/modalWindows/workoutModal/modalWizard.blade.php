        ...
        <form id="workoutForm" method="POST" enctype="multipart/form-data">
            <div class="wizard-body">
                ...
                <div class="form-group-element ">
                    ...
                    <input type="data" id="pubblicationDate" name='pubblicationDate' class="form-control" required>
                </div>
            </div>
    ...
    <div id="wizard_3" class="modal-wizard">
        ...
        <div class="wizard-body">
            <div class="form-group-element">
                ...
                <input type="text" name='workoutName' class="form-control" required>
            </div>
        </div>
        ...
        <div class="wizard-footer">
            <div class="button-wizard-container center-centered">
                ...
                <input type='submit' id="exerciseCreate" class="btn btn-success" value="submit">
            </div>
        </div>
        </form>
    </div>
